...
const teamMember = [
  {
    name: "hazrat Ali",
    image: "/images/friend-pic/Hazrat.jpg",
  ...
  {
    name: "Morsedul",
    image: "/images/friend-pic/Morsedul.jpg",
    role: "Chief Executive Officer",
    about: "The CEO's role in raising a company's corporate IQ is to establish an atmosphere that promotes knowledge sharing and collaboration.",
    social: {
      github: "",
  ...
  {
    name: "Sakib",
    image: "/images/friend-pic/sakib.jpg",
    role: "Chief Executive Officer",
    about: "The CEO's role in raising a company's corporate IQ is to establish an atmosphere that promotes knowledge sharing and collaboration.",
    social: {
      github: "",
  ...
  {
    name: "Riaz",
    image: "/images/friend-pic/riaz.jpg",
    role: "Chief Executive Officer",
    about: "The CEO's role in raising a company's corporate IQ is to establish an atmosphere that promotes knowledge sharing and collaboration.",
    social: {
      github: "",
  ...
  {
    name: "Sawon",
    image: "/images/friend-pic/sawon.jpg",
    role: "Chief Executive Officer",
    about: "The CEO's role in raising a company's corporate IQ is to establish an atmosphere that promotes knowledge sharing and collaboration.",
    social: {
      github: "",
  ...
  {
    name: "Sohan",
    image: "/images/friend-pic/sohan.jpg",
    role: "Chief Executive Officer",
    about: "The CEO's role in raising a company's corporate IQ is to establish an atmosphere that promotes knowledge sharing and collaboration.",
    social: {
      github: "",
  ...
  {
    name: "Sujon",
    image: "/images/friend-pic/sujon.jpg",
    role: "Chief Executive Officer",
    about: "The CEO's role in raising a company's corporate IQ is to establish an atmosphere that promotes knowledge sharing and collaboration.",
    social: {
      github: "",
      ...
      <div className="rounded overflow-hidden   bg-slate-700">
        ...
        <div className="px-6 mt-20">
          ...
          <div className="w-full flex justify-center pt-5 pb-5">
            <a href={data.social.github} className="mx-5">
            ...
            <a href={data.social.twitter} className="mx-5">
            ...
            <a href={data.social.instagram} className="mx-5">
